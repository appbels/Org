...
namespace Org\Schema\Thing\Intangible\Service\FinancialProduct\PaymentCard;

/**
 * Class CreditCard.
 * A card payment method of a particular brand or name. Used to mark up a
 * particular payment method and/or the financial product/service that supplies the card account.
 ...
 * Date         12/03/2017
 */
class CreditCard extends \Org\Schema\Thing\Intangible\Service\FinancialProduct\PaymentCard
{
	 ...
	 * @access  public
	 * @see     \Org\Schema\Thing\Intangible\Service\FinancialProduct\PaymentCard::__construct()
	 */
	 ...
	 * CreditCard toString.
	 * @access  public
	 * @see     \Org\Schema\Thing\Intangible\Service\FinancialProduct\PaymentCard::__toString()
	 *
	 * @return  string
	 */
	 ...
	 * @access  public
	 * @see     \Org\Schema\Thing\Intangible\Service\FinancialProduct\PaymentCard::__destruct()
	 */
