 ...
 * Date         09/04/2017
 */
class OfficeEquipmentStore extends \Org\Schema\Thing\Place\LocalBusiness\Store
{

	/**
	 * OfficeEquipmentStore constructor.
	 * @access  public
	...
	/**
	 * OfficeEquipmentStore destructor.
	 * @access  public
