 ...
 * Date         08/04/2017
 */
class CafeOrCoffeeShop extends \Org\Schema\Thing\Organization\LocalBusiness\FoodEstablishment
{

	/**
	 * CafeOrCoffeeShop constructor.
	 * @access  public
